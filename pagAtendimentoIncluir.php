		...
		<div class="row content">
			...
			<div class="col-sm-10">
					<form>
						...
						<p>
							Paciente: <input type="text" style='width:170px;border:none;border-bottom:solid;'>
							CPF: <input type="text" style='width:100px;border:none;border-bottom:solid;'><br><br>
							Médico: <input type="text" style='width:170px;border:none;border-bottom:solid;'>
							Data: <input type="text"style='width:100px;border:none;border-bottom:solid;'>
							<a href="pagAtendimentoIncluir.php" id="btnplus" class="glyphicon glyphicon-ok"></a>
							<a href="pagAtendimentoAgenda.php" id="btnplus" class="glyphicon glyphicon-remove"></a>
						</p>	
					</form>
					<hr>
